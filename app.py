...
if "person_row" in st.session_state and st.session_state.get("selected_row_found", False):
    ...
    # Removed merge_final_advice_grouped definition from here, it's global now
    ...
    # ==================== Urinalysis Section ====================
    # render_urine_section is now defined globally
    ...
    with st.container(): # This was 'with col_ua_left:', now it's a general container
        ...
        with col_ua_left:
            ...
            # render_stool_html_table is now defined globally
        ...
        with col_ua_right:
            ...
            # safe_text is now defined globally
