...
def render_section_header(title, subtitle=None):
    ...
    return f"""
    <div style='background-color: #f0f2f6; color: #333; text-align: center; padding: 0.3rem 0.4rem; font-weight: bold; border-radius: 6px; margin-top: 0.5rem; margin-bottom: 0.3rem; font-size: 16px; border: 1px solid #ddd;'>
        {full_title}
    </div>
    """
...
def render_header_and_vitals(person_data):
    ...
    <div class="header-grid">
        <div class="header-left">
            <h1 style="font-size: 24px; margin:0;">รายงานผลการตรวจสุขภาพ</h1>
    ...
    <hr style="border: 0; border-top: 1px solid #e0e0e0; margin: 0.3rem 0;">
    """
...
def get_main_report_css():
    ...
    <style>
        ...
        p, div, span, td, th { line-height: 1.35; }
        table { border-collapse: collapse; width: 100%; }
        .print-lab-table td, .print-lab-table th { padding: 3px 4px; border: 1px solid #ccc; text-align: center; vertical-align: middle; font-size: 14px; }
        ...
        .header-grid { display: flex; align-items: flex-end; justify-content: space-between; margin-bottom: 0.3rem; }
        .header-left { text-align: left; }
        .header-right { text-align: right; }
        .info-table { font-size: 15px; text-align: left; }
        ...
        .summary-box { background-color: #f8f9fa; border-radius: 4px; padding: 4px 8px; margin-top: 2px; font-size: 14px; }
